            ...
            <main>
                ...
                ?>
                    <div class="card-categorias">
                        ...
                        <img onclick="javascript: window.location = 
                            'editar.php?id=<?php echo $categoria['id']; ?>'"
                            src="https://icons.veryicon.com/png/o/application/enterprise-edition/edit-53.png" />
